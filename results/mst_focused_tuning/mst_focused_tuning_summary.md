...
The previous benchmark table showed that the validation-selected
...
- `results/mst_focused_tuning/mst_tuning_20260511_135539`
...
- Best test accuracy:
  - `mst_trial5` from
    `results/model_selection/fair_selection_20260510_145634`
