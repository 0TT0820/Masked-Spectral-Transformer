"""Reviewer-oriented hyperparameter search for Raman mineral classification.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fair hyperparameter search for reviewer model comparison.")
